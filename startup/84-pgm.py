...
pgm = PGM('XF:02IDB-OP{Mono:1', name='pgm', locations = {
         'mbg': ['m2off', 84.20033028, 'groff', 82.0737638 ,'grx', -63.0, 'grlines', 500], #'offset values confirmed in 5/7/2019
	 	 'ubg': ['m2off', 84.20265344, 'groff', 82.1012242016 , 'grx', -1,'grlines', 1800] }) #before 05/08/2019 'ubg': ['m2off', 84.20592917, 'groff', 82.1019478816 , 'grx', -1,'grlines', 1800] }) #'ubg': ['m2off', 84.20214532, 'groff', 82.1000625816] before 1/31/2019
