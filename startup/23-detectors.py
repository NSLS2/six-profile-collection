...
from ophyd import (EpicsSignal, EpicsSignalRO, EpicsScaler, Kind)


ring_curr = EpicsSignalRO('SR:OPS-BI{DCCT:1}I:Real-I', name='ring_curr')

gcpress = EpicsSignalRO('XF:02IDC-VA{BT:16-TCG:16_1}P-I',
                        name = 'gc_tcg_pressure')
...
sclr.channels.chan1.kind = Kind.normal
